// this is a copy-pasta of the original code at @cycle/isolate
// but with required function beings exported
...
export function checkIsolateArgs<So, Si>(
...
export function normalizeScopes<So>(
  sources: So,
  scopes: Scopes<So>,
  randomScope: string,
): ScopesPerChannel<So> {
...
export function isolateAllSources<So extends Sources>(
  outerSources: So,
...
export function isolateAllSinks<So extends Sources, Si>(
  sources: So,
  innerSinks: Si,
  scopes: ScopesPerChannel<So>,
): Si {
